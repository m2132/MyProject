...
namespace MyProject.Mock
{
    public class MockContext
    {
        ...
        public MockContext()
        {
            ...
            this.Permissions.Add(new Permission { Id = 2, Name = "VIEW_ALL_PRODUCT"});

            this.Claims.Add(new Claim { Id = 1, /*RoleId = 1, PermissionId = 1,*/ Policy = EPolicy.Allow });
            this.Claims.Add(new Claim { Id = 2, /*RoleId = 1, PermissionId = 2,*/ Policy = EPolicy.Allow });
            this.Claims.Add(new Claim { Id = 3, /*RoleId = 2, PermissionId = 1,*/ Policy = EPolicy.Deny });
